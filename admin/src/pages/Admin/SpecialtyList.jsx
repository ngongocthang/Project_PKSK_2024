    ...
    const deleteSpecialty = async (id, name) => {
        const confirmToastId = toast(
            <div className="flex flex-col items-center">
                <p className="mb-2 font-bold text-lg text-center">Bạn có chắc chắn muốn xóa chuyên khoa <strong className="text-red-600">{name}</strong> này không?</p>
                <div className="flex justify-center gap-2">
                    <button
                        onClick={async () => {
                            ...
                            try {
                                const response = await axios.delete(`${VITE_BACKEND_URI}/specialization/delete/${id}`);
        ...
        <div className="container mx-auto p-4">
            ...
            <div className="mt-4 overflow-x-auto bg-white rounded-md shadow-md">
                <table className="min-w-full table-auto bg-white border-collapse hidden md:table">
                    ...
                    <tbody>
                        {isLoading ? (
                                ...
                                <tr key={specialty._id} className="hover:bg-gray-50">
                                    ...
                                    <td className="py-2 px-4 border-b text-sm flex gap-2 h-[105px] justify-center items-center border-t">
                                        ...
                                        <svg
                                            ...
                                            fill="currentColor"
                                        >
                                            <path d="M5.755,20.283,4,8H20L18.245,20.283A2,2,0,0,1,16.265,22H7.735A2,2,0,0,1,5.755,20.283ZM21,4H16V3a1,1,0,0,0-1-1H9A1,1,0,0,0,8,3V4H3A1,1,0,0,0,3,6H21a1,1,0,0,0,0-2Z" fill="#c42121"></path>
                                        </svg>
                                    </td>
                                </tr>
                            ))
                            ...
                            <tr>
                                <td colSpan="4" className="py-4 text-center text-gray-500">Không có chuyên khoa nào.</td>
                            </tr>
                        )}
                    </tbody>
                </table>
                ...
                <div className="block md:hidden">
                    {currentSpecialties.map((specialty, index) => (
                        <div key={specialty._id} className="bg-gray-50 p-4 mb-2 rounded-md shadow-md flex flex-col gap-2">
                            ...
                            <div className="flex justify-center gap-2 mt-2">
                                ...
                                >
                                    <svg className="w-6 h-6 md:w-8 md:h-8 cursor-pointer" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
                                ...
                                >
                                    <svg className="w-6 h-6 md:w-8 md:h-8 cursor-pointer" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
                                        <path d="M5.755,20.283,4,8H20L18.245,20.283A2,2,0,0,1,16.265,22H7.735A2,2,0,0,1,5.755,20.283ZM21,4H16V3a1,1,0,0,0-1-1H9A1,1,0,0,0,8,3V4H3A1,1,0,0,0,3,6H21a1,1,0,0,0,0-2Z" fill="#ffffff"></path>
                                    </svg>
                                </button>
                            </div>
                        </div>
